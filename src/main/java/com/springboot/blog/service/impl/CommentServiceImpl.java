...
public class CommentServiceImpl implements CommentService {
    ...
    public CommentDto createComment(long postId, CommentDto commentDto) {
        ...
        return mapEntityToCommentDto(createdComment);
    }
    ...
    public CommentDto getCommentById(long postId, long commentId) {
        ...
        if (!comment.getPost().getId().equals(post.getId())){
            throw new BlogAPIException(HttpStatus.BAD_REQUEST, "Comment does not belongs to a post");
        }
        return mapEntityToCommentDto(comment);
    }
    ...
    public CommentDto updateComment(long postId, long commentId, CommentDto commentDto) {
        ...
        return mapEntityToCommentDto(updatedComment);
    }
